...
// https://docs.microsoft.com/en-us/cpp/preprocessor/alloc-text?view=msvc-160
//#ifdef ALLOC_PRAGMA
...
namespace ToyDriver
{
    ...
    )
    {
        ...
        do
        {
            ...
            if (NT_ERROR(status = WdfDeviceCreate(&deviceInit, WDF_NO_OBJECT_ATTRIBUTES, &ToyDriver::Globals::WDFDriverDevice)))
            {
            ...
            if (NT_ERROR(status = ToyDriver::Callouts::RegisterAllCallouts()))
            {
