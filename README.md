...
* [Programming the Windows Driver Model](https://www.microsoftpressstore.com/store/programming-the-microsoft-windows-driver-model-9780735618039) by Walter Oney. The book is a bit dated for Windows kernel programming, but can still be a useful resource. It's unfortunately out-of-print, but you can find it online on [flylib](https://flylib.com/books/en/4.167.1/).
